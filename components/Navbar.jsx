    ...
    <>
      <div className="max-w-full mx-auto">
        <ul className="md:flex items-center space-x-6">
          ...
          <li>
            <NavLink href="/project-information">Project Information</NavLink>
          </li>
          <li>
            {/* <Dropdown
              divisions={divisions}
        ...
        <div className="md:hidden flex items-center">
          <button className="outline-none mobile-menu-button">
            <svg className=" w-12 h-4 text-gray-500 hover:text-green-500 " fill="none" viewBox="0 0 24 24">
              <path
      ...
      <div className="hidden mobile-menu">
        <ul className="">
          <li className="active">
            <Link href="/">
              <a className="block text-sm px-2 py-4 text-white bg-green-500 font-semibold">Divisional Updates</a>
            </Link>
          </li>
          <li>
            <Link href="/hall-of-fame">
              <a className="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Hall of Fame</a>
            </Link>
          </li>
          <li>
